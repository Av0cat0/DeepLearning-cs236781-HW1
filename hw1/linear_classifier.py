...
class LinearClassifier(object):
    def __init__(self, n_features, n_classes, weight_std=0.001):
        ...
        # Creating the weight matrix with values generated from normal distribution
    ...
    def predict(self, x: Tensor):
        ...
        # Multiply matrices for class scores and find the most reasonable class to predict (argmax)
    ...
    def evaluate_accuracy(y: Tensor, y_pred: Tensor):
        ...
        #(sum of I(y==y_pred))/N loss function for a clasifier
    ...
    def train(
        ...
        for epoch_idx in range(max_epochs):
            ...
            # ====== YOUR CODE: ======
             ...
             #initalize variables for better understanding
            train_acc, train_loss = 0, 0
            N = 0
            reg_term = self.weights.norm().pow(2) * (weight_decay / 2)
            #using predict,loss_fn,grad,evaluate to get train results batch by batch
            for x, y in dl_train:
                y_pred, class_scores = self.predict(x)
                #adding reg term for loss
